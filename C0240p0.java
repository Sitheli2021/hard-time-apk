...
class C0240p0 {
    ...
    /* renamed from: b */
    private static int f1241b;

    /* renamed from: c */
    private static int f1242c;

    /* renamed from: d */
    private static int f1243d;
    ...
    private static class C0242b {
        ...
        /* renamed from: a */
        static int m731a(WindowManager windowManager) {
            Point point = new Point();
            windowManager.getDefaultDisplay().getSize(point);
            return point.x;
        }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:81:0x013e A[RETURN] */
    /* JADX WARNING: Removed duplicated region for block: B:82:0x013f  */
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static float m721a(android.view.View r9, android.content.Context r10, boolean r11, boolean r12, boolean r13, boolean r14) {
        /*
            r0 = 0
        ...
        L_0x0007:
            ...
            float r1 = m727b((android.view.View) r9)
        ...
        L_0x002c:
            ...
            int r7 = r7 + r8
            r6[r2] = r7
            int r7 = m724a((android.content.Context) r10)
            int r10 = m728b((android.content.Context) r10)
            r8 = r6[r1]
        ...
        L_0x0092:
            ...
            float r9 = m722a(r9, r3, r10, r1)     // Catch:{ Exception -> 0x00b2 }
        ...
        L_0x00c1:
            ...
            r8 = r3[r2]
            r4.<init>(r5, r6, r7, r8)
            int r5 = m724a((android.content.Context) r10)
            int r10 = m728b((android.content.Context) r10)
            r6 = r3[r1]
        ...
        L_0x011a:
            ...
            float r9 = m722a(r9, r4, r10, r2)     // Catch:{ Exception -> 0x0136 }
        ...
        L_0x0145:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.adcolony.sdk.C0240p0.m721a(android.view.View, android.content.Context, boolean, boolean, boolean, boolean):float");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static float m722a(android.view.View r11, android.graphics.Rect r12, float r13, boolean r14) {
        /*
        ...
        L_0x0035:
            ...
            float r8 = m727b((android.view.View) r5)
        ...
        L_0x00a9:
            ...
            boolean r10 = m729c(r9)
            if (r10 != 0) goto L_0x00cc
            int r10 = r9.getVisibility()
            if (r10 != 0) goto L_0x00a9
            float r10 = m727b((android.view.View) r9)
            int r10 = (r10 > r7 ? 1 : (r10 == r7 ? 0 : -1))
            if (r10 == 0) goto L_0x00a9
            r3.addFirst(r9)
            goto L_0x00a9
        L_0x00cc:
            java.util.ArrayList r9 = m726a((android.view.View) r9)
        ...
        L_0x0173:
            ...
            android.graphics.Rect r8 = m725a(r1, r12, r3)
            int r9 = r8.height()
        ...
        L_0x01b9:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.adcolony.sdk.C0240p0.m722a(android.view.View, android.graphics.Rect, float, boolean):float");
    }

    /* renamed from: a */
    private static int m723a() {
        return Build.VERSION.SDK_INT;
    }

    /* renamed from: a */
    private static int m724a(Context context) {
        int i;
        int i2;
        ...
        try {
            ...
            int a = m723a() >= 13 ? C0241a.m730a(windowManager) : windowManager.getDefaultDisplay().getHeight();
            if (i3 == 2) {
                f1240a = a;
            } else if (i3 == 1) {
                f1242c = a;
    ...
    /* renamed from: a */
    private static Rect m725a(Rect rect, Rect rect2, int i) {
        Rect rect3 = new Rect();
        switch (i) {
            case 1:
    ...
    /* renamed from: a */
    private static ArrayList<View> m726a(View view) {
        if ((view instanceof ViewGroup) && view.getVisibility() == 0 && m727b(view) != 0.0f) {
            ...
            while (listIterator.hasNext()) {
                ...
                for (int i = 0; i < childCount; i++) {
                    ...
                    if (childAt.getVisibility() == 0 && m727b(childAt) != 0.0f) {
    ...
    /* renamed from: b */
    private static float m727b(View view) {
        if (view == null) {
            return 0.0f;
        }
        if (m723a() < 11) {
    ...
    /* renamed from: b */
    private static int m728b(Context context) {
        int i;
        int i2;
        int i3 = context != null ? context.getResources().getConfiguration().orientation : -1;
        if (i3 == 2 && (i2 = f1241b) > 0) {
        ...
        try {
            WindowManager windowManager = (WindowManager) context.getApplicationContext().getSystemService("window");
            int a = m723a() >= 13 ? C0242b.m731a(windowManager) : windowManager.getDefaultDisplay().getWidth();
            if (i3 == 2) {
                f1241b = a;
            } else if (i3 == 1) {
                f1243d = a;
    ...
    /* renamed from: c */
    private static boolean m729c(View view) {
        if (view == null) {
            return false;
        }
        return view.getBackground() == null || (m723a() > 18 && view.getBackground().getAlpha() == 0);
    }
}
